        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/campaigns" className="text-gray-400 hover:text-white">Browse Campaigns</Link></li>
              <li><Link to="/create-campaign" className="text-gray-400 hover:text-white">Start a Campaign</Link></li>
